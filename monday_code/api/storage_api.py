...
class StorageApi:
    ...
    def _delete_by_key_from_storage_serialize(
        self,
        key,
    ...
    def _get_by_key_from_storage_serialize(
        self,
        key,
        shared,
        x_monday_access_token,
    ...
    def _increment_counter_serialize(
        self,
        x_monday_access_token,
    ...
    def _search_record_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/storage/search/{term}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def upsert_by_key_from_storage(
        ...
        :param x_monday_access_token: (required)
        :type x_monday_access_token: str
        :param json_data_contract: (required)
        :type json_data_contract: JsonDataContract
        :param shared:
        :type shared: bool
