...
class QueueApi:
    ...
    def publish_message(
        ...
        :param publish_message_params: (required)
        :type publish_message_params: PublishMessageParams
    ...
    def publish_message_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PublishMessageResponse]:
        """publish_message
    ...
    def validate_secret(
        ...
        :param validate_secret_params: (required)
        :type validate_secret_params: ValidateSecretParams
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def validate_secret_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ValidateSecretResponse]:
        """validate_secret
    ...
    def _validate_secret_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/queue/validate-secret',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
