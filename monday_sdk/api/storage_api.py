...
class StorageApi:
    ...
    def get_storage_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[StorageDataContract]:
        """get_storage
    ...
    def put_storage(
        ...
        _param = self._put_storage_serialize(
            key=key,
            x_monday_access_token=x_monday_access_token,
            shared=shared,
    ...
    @validate_call
    def put_storage_with_http_info(
        self,
        key: StrictStr,
        x_monday_access_token: StrictStr,
        shared: StrictBool,
    ...
    @validate_call
    def put_storage_without_preload_content(
        self,
        key: StrictStr,
        x_monday_access_token: StrictStr,
        shared: StrictBool,
    ...
    def storage_increment_counter(
        ...
        :param key: (required)
        :type key: str
        :param increment_counter_params: (required)
        :type increment_counter_params: IncrementCounterParams
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._storage_increment_counter_serialize(
            x_monday_access_token=x_monday_access_token,
            key=key,
            increment_counter_params=increment_counter_params,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def storage_increment_counter_with_http_info(
        self,
        x_monday_access_token: StrictStr,
        key: StrictStr,
        increment_counter_params: IncrementCounterParams,
    ...
    @validate_call
    def storage_increment_counter_without_preload_content(
        self,
        x_monday_access_token: StrictStr,
        key: StrictStr,
        increment_counter_params: IncrementCounterParams,
    ...
    def _storage_increment_counter_serialize(
        self,
        x_monday_access_token,
        key,
        increment_counter_params,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if increment_counter_params is not None:
            _body_params = increment_counter_params
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/storage/{key}/counter/increment',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
